...
const (
	...
	CreditCardService_CreateCreditCard_FullMethodName               = "/user.CreditCardService/CreateCreditCard"
)
...
type CreditCardServiceClient interface {
	...
	CreateCreditCard(ctx context.Context, in *CreditCard, opts ...grpc.CallOption) (*CreditCard, error)
}
...
func (c *creditCardServiceClient) CreateCreditCard(ctx context.Context, in *CreditCard, opts ...grpc.CallOption) (*CreditCard, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreditCard)
...
type CreditCardServiceServer interface {
	...
	CreateCreditCard(context.Context, *CreditCard) (*CreditCard, error)
...
func (UnimplementedCreditCardServiceServer) CreateCreditCard(context.Context, *CreditCard) (*CreditCard, error) {
...
func _CreditCardService_CreateCreditCard_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CreditCardServiceServer).CreateCreditCard(ctx, req.(*CreditCard))
	}
	return interceptor(ctx, in, info, handler)
}
